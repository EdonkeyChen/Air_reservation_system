			...
			<div class="tab-content magintop-2">
				<div role="tabpanel" class="tab-pane active" id="Aircraft">
					<div class="col-md-6 col-md-offset-3">
						<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/addAircraft.do">
<%
...
%>
							<div class="form-group">
								<label for="Phone" class="col-sm-4 control-label">Aircraft Name</label>
								<div class="col-sm-6">
									<input class="form-control" id="Phone" required placeholder="Aircraft Name" name="aircraft_name">
								</div>
							</div>
							<div class="form-group">
